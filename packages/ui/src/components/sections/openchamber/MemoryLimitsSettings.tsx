        ...
        <div className="flex items-center gap-2">
          ...
          <Tooltip delayDuration={1000}>
            ...
            <TooltipContent sideOffset={8} className="max-w-xs">
              {t('settings.memory.tooltipLine1')}<br />
              {t('settings.memory.tooltipLine2')}
            </TooltipContent>
          </Tooltip>
        </div>
      </div>
      ...
      <section className="px-2 pb-2 pt-0">
        <div className="flex flex-col gap-2 py-1.5 sm:flex-row sm:items-center sm:gap-8">
          <div className="flex min-w-0 flex-col sm:w-56 shrink-0">
            <span className="typography-ui-label text-foreground">{t('settings.memory.messageLimit')}</span>
          </div>
          <div className="flex items-center gap-2 sm:w-fit">
            <NumberInput
              ...
              max={MAX_LIMIT}
              step={10}
              aria-label={t('settings.memory.messageLimitAria')}
            ...
            <ButtonSmall
              ...
              aria-label={t('settings.memory.resetMessageLimitAria')}
